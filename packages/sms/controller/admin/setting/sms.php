...
class SMS extends \Controller {
	...
	public function install() {
		...
		$this->model_core_event->addEvent('sms', 'api/controller/startup/event/after', 'event/sms/startup');
		$this->model_core_event->addEvent('sms', 'admin/controller/startup/event/after', 'event/sms/startup');
