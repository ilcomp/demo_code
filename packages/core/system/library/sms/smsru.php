...
class SmsRu
{
    const URL_SMSAERO_API = 'https://sms.ru/';
    ...
    public function send($number, $text, $channel, $dateSend = null, $callbackUrl = null){
        ...
        return array(
            'success' => $return['status_code'] == 100,
            'data' => $data,
        );
    }
    ...
    public function balance(){
        $return = json_decode(self::curl_post(self::URL_SMSAERO_API . '/my/balance', []), true);

        return array(
            'success' => $return['status_code'] == 100,
            'data' => array('balance' => isset($return['balance']) ? $return['balance'] : 0),
            'return' => $return,
        );
    }
