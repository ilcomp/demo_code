<?php
// HTTP
define('HTTP_APPLICATION', HTTP_SERVER);
define('HTTP_APPLICATION_ADMIN', HTTP_SERVER . 'admin/');
define('HTTP_APPLICATION_API', HTTP_SERVER . 'api/v1/');

// DIR
define('DIR_CONTROLLER', DIR_APP . 'controller/client/');
define('DIR_LANGUAGE', DIR_APP . 'language/client/');
