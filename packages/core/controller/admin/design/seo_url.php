...
class SeoUrl extends \Controller {
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('design/seo_url/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('design/seo_url/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('design/seo_url_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('design/seo_url', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('design/seo_url_form', $data);
	...
	protected function validateForm() {
		...
		if ($this->request->post['query']) {
			...
			foreach ($seo_urls as $seo_url) {
				if ($seo_url['store_id'] == $this->request->post['store_id'] && $seo_url['language_id'] == $this->request->post['language_id'] && (!isset($this->request->get['seo_url_id']) || ($seo_url['seo_url_id'] != $this->request->get['seo_url_id']))) {
