...
class Zone extends \Controller {
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('localisation/zone/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('localisation/zone/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['zones'] = $this->model_localisation_zone->getZones($filter_data);

		foreach ($data['zones'] as &$result) {
			$result['name'] = $result['name'] . (($result['zone_id'] == $this->config->get('config_zone_id')) ? $this->language->get('text_default') : null);
			$result['edit'] = $this->url->link('localisation/zone/edit', 'user_token=' . $this->session->data['user_token'] . '&zone_id=' . $result['zone_id'] . $url);
		}
		unset($result);
		...
		$data['content'] = $this->load->view('localisation/zone_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('localisation/zone', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('localisation/zone_form', $data);
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $zone_id) {
			...
			$store_total = $this->model_core_store->getTotalStoresByZoneId($zone_id);
