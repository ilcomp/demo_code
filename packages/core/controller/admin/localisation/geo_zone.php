...
class GeoZone extends \Controller {
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('localisation/geo_zone/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('localisation/geo_zone/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['geo_zones'] = $this->model_localisation_geo_zone->getGeoZones($filter_data);

		foreach ($data['geo_zones'] as &$result) {
			$result['edit'] = $this->url->link('localisation/geo_zone/edit', 'user_token=' . $this->session->data['user_token'] . '&geo_zone_id=' . $result['geo_zone_id'] . $url);
		...
		$data['content'] = $this->load->view('localisation/geo_zone_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('localisation/geo_zone', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('localisation/geo_zone_form', $data);
