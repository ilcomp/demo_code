...
class Event extends \Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			foreach ($this->request->post['selected'] as $event_id) {
				$this->model_core_event->deleteEvent($event_id);
			}
	...
	public function getList() {
		...
		$data['actions']['delete'] = $this->url->link('marketplace/event/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$event_total = $this->model_core_event->getTotalEvents();

		$results = $this->model_core_event->getEvents($filter_data);
		...
		$data['content'] = $this->load->view('marketplace/event', $data);
	...
	public function enable() {
		...
		if (!$this->user->hasPermission('modify', 'marketplace/event')) {
			...
			$this->model_core_event->editStatus($event_id, 1);
	...
	public function disable() {
		...
		if (!$this->user->hasPermission('modify', 'marketplace/event')) {
			...
			$this->model_core_event->editStatus($event_id, 0);
