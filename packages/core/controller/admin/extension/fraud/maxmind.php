<?php
namespace Controller\Extension\Fraud;
...
class MaxMind extends \Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_core_setting->editSetting('fraud_maxmind', $this->request->post);
		...
		$data['actions']['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=fraud');
		...
		$data['content'] = $this->load->view('extension/fraud/maxmind', $data);
