...
class SeoRegex extends \Model {
	...
	public function deleteSeoRegexByName($name) {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "seo_regex` WHERE `name` = '" . $this->db->escape((string)$name) . "'");
	}
