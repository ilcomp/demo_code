...
class SubTotal extends \Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_core_setting->editSetting('total_sub_total', $this->request->post);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/total/sub_total')
		);

		$data['action'] = $this->url->link('extension/total/sub_total');
		...
		$data['content'] = $this->load->view('extension/total/sub_total', $data);
