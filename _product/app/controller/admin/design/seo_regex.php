...
class SeoRegex extends \Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('design/seo_regex/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('design/seo_regex/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['pagination'] = $this->load->controller('block/pagination', array(
			...
			'page'  => $page,
			'limit' => $this->config->get('config_limit'),
			'url'   => $this->url->link('design/seo_regex', 'user_token=' . $this->session->data['user_token'] . '&page={page}')
		));
		...
		$data['content'] = $this->load->view('design/seo_regex_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('design/seo_regex', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('design/seo_regex_form', $data);
