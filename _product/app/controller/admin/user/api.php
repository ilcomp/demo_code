...
class Api extends \Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_core_api->addApi($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_core_api->editApi($this->request->get['api_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $api_id) {
				$this->model_core_api->deleteApi($api_id);
			}
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('user/api/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('user/api/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$user_total = $this->model_core_api->getTotalApis();

		$results = $this->model_core_api->getApis($filter_data);
		...
		$data['content'] = $this->load->view('user/api_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('user/api', 'user_token=' . $this->session->data['user_token'] . $url);

		if (isset($this->request->get['api_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$api_info = $this->model_core_api->getApi($this->request->get['api_id']);
		}
		...
		if (isset($this->request->post['api_ip'])) {
			...
			$data['api_ips'] = $this->model_core_api->getApiIps($this->request->get['api_id']);
		} else {
			$data['api_ips'] = array();
		}
		...
		if (isset($this->request->get['api_id'])) {
			$results = $this->model_core_api->getApiSessions($this->request->get['api_id']);
		...
		$data['content'] = $this->load->view('user/api_form', $data);
	...
	public function deleteSession() {
		...
		if (!$this->user->hasPermission('modify', 'user/api')) {
			...
			$this->model_core_api->deleteApiSession($this->request->get['api_session_id']);
