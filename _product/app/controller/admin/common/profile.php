...
class Profile extends \Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_core_user->editUser($this->user->getId(), $user_data);
		...
		$data['action'] = $this->url->link('common/profile');

		$data['actions']['save'] = true;
		$data['actions']['cancel'] = $this->url->link($this->config->get('action_default'));
		...
		if (isset($this->request->post['image']) && is_file(DIR_IMAGE . $this->request->post['image'])) {
			...
			$data['thumb'] = $this->model_tool_image->resize($user_info['image'], $thumb_width, $thumb_height);
		} else {
			$data['thumb'] = $data['placeholder'];
		}

		$data['content'] = $this->load->view('common/profile', $data);
