...
class Language extends \Controller {
	...
	protected function getList() {
		...
		$data['actions']['add'] = $this->url->link('localisation/language/add', 'user_token=' . $this->session->data['user_token'] . $url);
		$data['actions']['delete'] = $this->url->link('localisation/language/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		foreach ($data['languages'] as &$result) {
			$result['name'] = $result['name'] . (($result['code'] == $this->config->get('config_language')) ? $this->language->get('text_default') : null);
			$result['edit'] = $this->url->link('localisation/language/edit', 'user_token=' . $this->session->data['user_token'] . '&language_id=' . $result['language_id'] . $url);
		}
		unset($result);
		...
		$data['content'] = $this->load->view('localisation/language_list', $data);
	...
	protected function getForm() {
		...
		$data['actions']['cancel'] = $this->url->link('localisation/language', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$data['content'] = $this->load->view('localisation/language_form', $data);
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $language_id) {
			...
			if ($language_info) {
				...
				$store_total = $this->model_core_store->getTotalStoresByLanguage($language_info['code']);
