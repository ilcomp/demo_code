...
class ControllerMarketplaceModification extends Controller {
	...
	public function index() {
		...
		$this->load->model('core/modification');
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			foreach ($this->request->post['selected'] as $modification_id) {
				$this->model_core_modification->deleteModification($modification_id);
			}
	...
	public function refresh($data = array()) {
		...
		if ($this->validate()) {
			...
			$this->model_core_setting->editSettingValue('config', 'config_maintenance', true);
			...
			$results = $this->model_core_modification->getModifications();
			...
			$this->model_core_setting->editSettingValue('config', 'config_maintenance', $maintenance);
	...
	public function enable() {
		...
		if (isset($this->request->get['modification_id']) && $this->validate()) {
			$this->model_core_modification->enableModification($this->request->get['modification_id']);
	...
	public function disable() {
		...
		if (isset($this->request->get['modification_id']) && $this->validate()) {
			$this->model_core_modification->disableModification($this->request->get['modification_id']);
	...
	protected function getList() {
		...
		$data['actions']['delete'] = $this->url->link('marketplace/modification/delete', 'user_token=' . $this->session->data['user_token'] . $url);
		...
		$modification_total = $this->model_core_modification->getTotalModifications();

		$results = $this->model_core_modification->getModifications($filter_data);
		...
		$data['content'] = $this->load->view('marketplace/modification', $data);
