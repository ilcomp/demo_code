...
class Installer extends \Controller {
	public function index() {
		...
		$data['content'] = $this->load->view('marketplace/installer', $data);
	...
	public function history() {
		...
		$results = $this->model_core_extension->getExtensionInstalls(($page - 1) * 10, 10);
		...
		$history_total = $this->model_core_extension->getTotalExtensionInstalls();
	...
	public function upload() {
		...
		if (!$json) {
			...
			if (is_file($file)) {
				...
				$extension_install_id = $this->model_core_extension->addExtensionInstall($this->request->files['file']['name']);
