...
$_['text_isbn']                  = 'ISBN';
$_['text_mpn']                   = 'MPN';
$_['text_tracking']              = 'Номер отслеживания';
...
$_['text_client']                = 'Информация о получателе';
$_['text_shipping']              = 'Информация о доставке';
$_['text_additionally']          = 'Дополнительно';
$_['text_invoice_send']          = 'Вы действительно хотите отправить счёт пользователю на email:';
$_['text_manager']               = 'Менеджер';
$_['text_export']                = 'Экспорт в файл';

// Column
$_['column_order_id']            = '№ Заказа';
$_['column_account']             = 'Клиент';
...
$_['entry_account']             = 'Клиент';
$_['entry_account_group']       = 'Группа покупателей';
...
$_['entry_total_shipping']       = 'Изменить стоимость доставки';
$_['entry_total_order_sale']     = 'Изменить процент скидки';

// Button
$_['button_invoice_send']        = 'Отправить счет на оплату';
