...
class SmsaeroApiV2 {
    ...
    public function send($number, $text, $channel, $dateSend = null, $callbackUrl = null){
        return json_decode(self::curl_post(self::url . '/sms/send/', [
    ...
    public function check_send($id){
        return json_decode($this->curl_post(self::url . '/sms/status/', [
            'id' => $id
        ]), true);
    }
    ...
    public function sms_list($number = null, $text = null, $page = null){
        ...
        return json_decode(self::curl_post(self::url . '/sms/list' . $page, [
            'number' => $number,
            'text' => $text
        ]), true);
    }
    ...
    public function balance(){
        return json_decode(self::curl_post(self::url . '/balance', []), true);
    }
    ...
    public function tariffs(){
        return json_decode(self::curl_post(self::url . '/tariffs', []), true);
    }
    ...
    public function sign_add($name){
        return json_decode(self::curl_post(self::url . '/sign/add', [
            'name' => $name
        ]), true);
    }
    ...
    public function sign_list(){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode(self::curl_post(self::url . '/sign/list' . $page, []), true);
    }
    ...
    public function group_add($name){
        return json_decode(self::curl_post(self::url . '/group/add', [
            'name' => $name
        ]), true);
    }
    ...
    public function group_delete($id){
        return json_decode(self::curl_post(self::url . '/group/delete', [
            'id' => $id
        ]), true);
    }
    ...
    public function group_list($page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode(self::curl_post(self::url . '/group/list' . $page, []), true);
    }
    ...
    public function contact_add($number, $groupId = null, $birthday = null, $sex = null, $lname = null,
        ...
        return json_decode(self::curl_post(self::url . '/contact/add', [
            'number' => $number,
            'groupId' => $groupId,
            'birthday' => $birthday,
            'sex' => $sex,
    ...
    public function contact_delete($id){
        return json_decode(self::curl_post(self::url . '/contact/delete', [
            'id' => $id
        ]), true);
    }
    /**
    ...
    public function contact_list($number = null, $groupId = null, $birthday = null, $sex = null, $operator = null,
        ...
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode(self::curl_post(self::url . '/contact/list' . $page, [
            'number' => $number,
            'groupId' => $groupId,
            'birthday' => $birthday,
            'sex' => $sex,
    ...
    public function blacklist_add($number){
        return json_decode(self::curl_post(self::url . '/blacklist/add', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public  function blacklist_delete($id){
        return json_decode(self::curl_post(self::url. '/blacklist/delete', [
            'id' => $id
        ]), true);
    }
    ...
    public function blacklist_list($number = null, $page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode(self::curl_post(self::url . '/blacklist/list' . $page, [
            'number' => $number
        ]), true);
    }
    ...
    public function hlr_check($number){
        return json_decode(self::curl_post(self::url . '/hlr/check', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public function hlr_status($id){
        return json_decode(self::curl_post(self::url. '/hlr/status', [
            'id' => $id
        ]), true);
    }
    ...
    public function number_operator($number){
        return json_decode(self::curl_post(self::url . '/number/operator', [
            is_array($number) ? 'numbers' : 'number' => $number
        ]), true);
    }
    ...
    public function viber_send($number = null, $groupId = null, $sign, $channel, $text, $imageSource = null, $textButton = null,
        ...
        return json_decode(self::curl_post(self::url . '/viber/send', [
    ...
    public function viber_statistic($sendingId, $page = null){
        isset($page) ? $page = '?page=' . $page : $page = '';
        return json_decode(self::curl_post(self::url . '/viber/statistic' . $page, [
            'sendingId' => $sendingId
        ]), true);
    }
    ...
    public function viber_list(){
        return json_decode(self::curl_post(self::url . '/viber/list', []), true);
    }
    ...
    public function viber_sign_list(){
        return json_decode(self::curl_post(self::url . '/viber/sign/list', []), true);
    }
}